<script lang="ts">
	...
	import { OrgForm } from '$lib/components/admin/forms';
...
<div class="mx-auto max-w-2xl space-y-8 p-6">
	<div class="space-y-2">
		...
		<p class="text-gray-500 dark:text-gray-400">Update a client organization to the system.</p>
	</div>
	
	<OrgForm formData={data.form} mode="update" />
</div>
